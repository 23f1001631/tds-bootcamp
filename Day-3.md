...
--- Before Day-3 ---
I already knew basic Python programming and package installation concepts.
---
...
--- After Day-3 ---
I learned more about Python project management using uv, dependency handling, virtual environments, and project configuration using pyproject.toml.
---

--- Feedback (Suggestions for the TDS Team) ---
The Python environment setup explanations were very helpful. More beginner examples for uv commands would make the learning smoother.
---
