...
--- Before Day-4 ---
I already knew some basic API and browser concepts.
--- 
...
--- After Day-4 ---
I learned more about APIs, HTTP methods, status codes, browser network tools, curl commands, and FastAPI endpoint testing.
---

--- Feedback (Suggestions for the TDS Team) ---
The API exercises were practical and beginner friendly. More debugging examples would help learners understand HTTP concepts better.
---
